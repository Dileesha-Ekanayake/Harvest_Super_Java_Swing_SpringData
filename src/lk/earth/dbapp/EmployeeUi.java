...
public class EmployeeUi extends JFrame {
    ...
    public void loadForm() {
        ...
        deslist = designationService.getAll();
        ...
        stslist = statusemployeeService.getAll();
    ...
    public void loadView() {
        ...
        emplist = EmployeeManager.get(null);
        fillTable(emplist);

        List<Gender> genlist = genderService.getAll();
        Vector<Object> genders = new Vector();
        genders.add("Select a Gender");
        ...
        List<Designation> deslist = designationService.getAll();
        Vector<Object> designations = new Vector();
        designations.add("Select a Designation");
    ...
    public void btnSearchAp(ActionEvent e) {
        ...
        List<Employee> employees = EmployeeManager.get(ht);
        fillTable(employees);
    ...
    public void btnSearchClearAp(ActionEvent e) {
        ...
        if (opt != 1) {
            ...
            List<Employee> employees = EmployeeManager.get(null);
            fillTable(employees);
    ...
    public void btnUpdateAp(ActionEvent e) {
        ...
        if (error.isEmpty()) {
            ...
            if (!updates.isEmpty()) {
                int resp = JOptionPane.showConfirmDialog(null, "You Have FollowingUpdates\n\n" + updates);
                if (resp == 0) {
